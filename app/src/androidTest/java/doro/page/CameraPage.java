...
public class CameraPage {
    ...
    public static final String HOME_GROUP_VIEW =
            "com.doro.apps.launcher3:id/shortcut_list";
    //主界面快捷方式列表

    public static final String CAMERA_FRONT_SWITCH_BUTTON =
            "com.mediatek.camera:id/onscreen_camera_picker";
    //前后摄像头切换按钮

    public static final String CAMERA_FLASH_BUTTON =
            "com.mediatek.camera:id/onscreen_flash_picker";
    //闪光灯按钮

    public static final String CAMERA_SETTINGS_BUTTON =
            "com.mediatek.camera:id/setting_indicator";
    //相机设置按钮

    public static final String CAMERA_CAPTURE_BUTTON =
            "com.mediatek.camera:id/shutter_button_photo";
    //相机拍照按钮

    public static final String CAMERA_RECORD_BUTTON =
            "com.mediatek.camera:id/shutter_button_video";
    //录像按钮

    public static final String CAMERA_FOCUS_AREA =
            "com.mediatek.camera:id/distance_info";
    //预览中心区域

    public static final String CAMERA_MINI_BOX = "com.mediatek.camera:id/thumbnail";
    //相机界面mini框

    public static final String I_WANT_TO_BUTTON = "I want to";
    //iwantto按钮
    ...
    public static final String PICTURE_NAME = "com.doro.apps.gallery:id/name";
    //照片名字

    public static final String OK_BUTTON = "OK";
    //ok按钮

    public static final String GALLERY = "com.doro.apps.gallery";
    //图库包名
    ...
    public static final String GALLERY_VIDEO_PLAY_VIEW =
            "com.doro.apps.gallery:id/video_view";
    //播放视频界面
